  ...
  User.init(
    {
      ...
      email_address: {
        ...
        validate: {
          isEmail: {
            args: true,
            msg: "[users].[email_address] must be unique!",
          },
          notNull: { msg: "[users].[email_address] cannot be null!" },
          notEmpty: {
            msg: "[users].[email_address] cannot be blank or empty!",
          },
        },
      ...
      contact_number: {
        ...
        validate: {
          ...
          notEmpty: {
            msg: "[users].[contact_number] cannot be blank or empty",
          },
        },
      ...
      verified: {
        ...
        validate: {
          isIn: {
            args: [["Approved", "Pending", "Declined"]],
            msg: "[users].[user_type] value must be `Admin`, `Librarian` or `Resident` only",
          },
        },
        comment: `This indicates if the account of a user is verified or not:
                Approved - May Card or nakaset to Approved kapag Admin or Librarian
                Pending - Ichecheck pa kung valid barangay_card yung sinubmit
                Declined - Kapag maling card ang sinubmit and kapag declined ang status kailangan magreupload`,
      },
      ...
      created_by: {
        ...
        validate: {
          isUUID: {
            args: 4,
            msg: "[users].[updated_by] value must be a UUIDV4 type",
          },
        },
        comment:
          "This column is specifically for Admin and Librarian, that determines who created the user.",
      },
      ...
      updated_by: {
        ...
        comment:
          "This column is specifically for Admin and Librarian, that determines who updated the user.",
      },
      ...
      verified_by: {
        ...
        comment:
          "This column is specifically for Admin and Librarian, that determines who verified the Civilian in the API.",
      },
