      ...
      db.User.findOne({
        ...
        .then((data) =>
          dataResponse(
            res,
            data,
            "Admin is successfully registered in the database.",
            "No such admin has been identified."
          )
        )
        .catch((err) => errResponse(res, err));
    })
      ...
      db.User.findOne({
        ...
        .then((data) =>
          dataResponse(
            res,
            data,
            "Librarian is successfully registered in the database.",
            "No such librarian has been identified."
          )
        )
        .catch((err) => errResponse(res, err));
    })
