 ...
 * * INFO CONTROLLER
 * =====================================================================
 * This controller is for querying resident related information
 * =====================================================================
 */
...
exports.getInfo = (req, res, next) => {
    ...
    db.User.findOne({
        ...
        attributes: ['user_id', 'full_name', 'email_address', 'contact_number', 'user_type', 'status'],
        include: [
            {
                model: db.User,
...
// % ROUTE: /ebasa/v1/resident/info/change-password
...
// % ROUTE: /ebasa/v1/resident/info/change-profile-pic
